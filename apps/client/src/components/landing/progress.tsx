                ...
                <div className="w-full mt-10 flex flex-col justify-center items-center">
                  ...
                  <div className="flex items-center mt-3">
                    ...
                    <p className="font-medium text-gray-600">
                      {moment(habitsList.habits[1].startDay).format("MMMM Do, YYYY")}
                    </p>
                  </div>
                  ...
                  <div className="w-full -mt-5 -mb-12">
                    <ProgressBar
                      bgcolor={"#a7c957"}
                      completed={(habitsList.habits[1].currentProgress + 3)* 7}
                    />
                  </div>
                  ...
                  <div className="w-full flex justify-center items-center mt-7">
                    <button className="btn bg-[#a7c957] hover:bg-amber-300/80 text-white border-none text-xs">
                      click here to log your todays progress 🚀
                    </button>
                    <Link to="/start-over">
