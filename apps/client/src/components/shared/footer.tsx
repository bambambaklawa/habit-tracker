const Footer = () => {
  return (
    <footer className="footer footer-center bg-gradient-to-br from-[#f5f7fa] to-[#c3cfe2] text-primary-content p-10">
      <aside>
        <svg
          viewBox="0 0 64 64"
